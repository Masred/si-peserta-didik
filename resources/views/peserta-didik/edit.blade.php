...
@section('content')
    <div class="card card-lightblue">
        ...
        <!-- /.card-header -->
        <form action="{{ route('peserta-didik.update', $peserta_didik->nipd) }}" method="post">
            @csrf
            @method('patch')
            <div class="card-body">
                <h3>Peserta Didik</h3>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <select name="jenis_pendaftaran" id="jenis_pendaftaran"
                            ...
                            <option value="Siswa baru"
                                {{ old('jenis_pendaftaran', $peserta_didik->jenis_pendaftaran) == 'Siswa baru' ? 'selected' : '' }}>
                                Siswa
                                baru
                            </option>
                            <option value="Pindahan"
                                {{ old('jenis_pendaftaran', $peserta_didik->jenis_pendaftaran) == 'Pindahan' ? 'selected' : '' }}>
                                Pindahan
                            </option>
                            <option value="Kembali bersekolah"
                                {{ old('jenis_pendaftaran', $peserta_didik->jenis_pendaftaran) == 'Kembali bersekolah' ? 'selected' : '' }}>
                                Kembali bersekolah
                            </option>
                        </select>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input type="number" min="1" class="form-control @error('nipd') is-invalid @enderror" id="nipd"
                            placeholder="Masukan NIPD/NIS" name="nipd" value="{{ old('nipd', $peserta_didik->nipd) }}">
                        @error('nipd')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input type="number" min="1" class="form-control @error('nisn') is-invalid @enderror" id="nisn"
                            placeholder="Masukan NISN" name="nisn" value="{{ old('nisn', $peserta_didik->nisn) }}">
                        @error('nisn')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <select name="jenis_kelamin" id="jenis_kelamin"
                            ...
                            <option value="">PILIH</option>
                            <option value="L"
                                {{ old('jenis_kelamin', $peserta_didik->jenis_kelamin) == 'L' ? 'selected' : '' }}>
                                Laki - Laki
                            </option>
                            <option value="P"
                                {{ old('jenis_kelamin', $peserta_didik->jenis_kelamin) == 'P' ? 'selected' : '' }}>
                                Perempuan
                            </option>
                        </select>
                        @error('jenis_kelamin')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input type="number" min="1" class="form-control @error('nik') is-invalid @enderror" id="nik"
                            placeholder="Masukan Nomor Induk Kependudukan" name="nik"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input type="tel" class="form-control @error('hp') is-invalid @enderror" id="hp"
                            placeholder="Masukan Nomor HP" name="hp" value="{{ old('hp', $peserta_didik->hp) }}">
                        @error('hp')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input type="email" class="form-control @error('email') is-invalid @enderror" id="email"
                            placeholder="Masukan Email" name="email" value="{{ old('email', $peserta_didik->email) }}">
                        @error('email')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input type="text" class="form-control @error('alamat') is-invalid @enderror" id="alamat"
                            placeholder="Masukan Alamat Jalan" name="alamat"
                ...
                <div class="form-group row">
                    <label for="status" class="col-md-4 col-form-label text-md-right"
                        title="Status peserta didik saat ini.">Status</label>
                    <div class="col-md-6">
                        <select name="status" id="status" class="custom-select @error('status') is-invalid @enderror">
                            <option value="">PILIH</option>
                            <option value="aktif"
                                {{ old('status', $peserta_didik->status) == 'aktif' ? 'selected' : '' }}>
                                Aktif
                            </option>
                            <option value="keluar"
                                {{ old('status', $peserta_didik->status) == 'keluar' ? 'selected' : '' }}>
                                Keluar
                            </option>
                        </select>
                        @error('status')
                ...
                <hr>
                <div class="form-group row">
                    <label for="keluar_karena" class="col-md-4 col-form-label text-md-right"
                        title="Alasan utama peserta didik keluar dari sekolah. Pilih Lulus apabila peserta didik telah lulus dari seklolah, pilih Mengundurkan diri apabila peserta didik keluar sekolah karena mengundurkan diri dengan catatan (dibuktikan adanya surat pengunduran diri), pilih Putus sekolah apabila peserta didik meninggalkan sekolah tanpa keterangan yang jelas.">Keluar
                        Karena</label>
                    <div class="col-md-6">
                        <select name="keluar_karena" id="keluar_karena"
                            ...
                            <option value="Mengundurkan diri"
                                {{ old('keluar_karena') == 'Mengundurkan diri' ? 'selected' : '' }}>
                                Mengundurkan diri
                            </option>
                            <option value="Putus Sekolah"
                                {{ old('keluar_karena') == 'Putus Sekolah' ? 'selected' : '' }}>
                                Putus
                                Sekolah
                            </option>
                ...
                <div class="form-group row">
                    <label for="pindah_ke" class="col-md-4 col-form-label text-md-right"
                        title="Diisi dengan nama sekolah yang peserta didik tuju untuk pindah.">Pindah Ke</label>
                    <div class="col-md-6">
                        <input type="text" class="form-control @error('pindah_ke') is-invalid @enderror" id="pindah_ke"
                            placeholder="Masukan Nama sekolah tujuan" name="pindah_ke" value="{{ old('pindah_ke') }}">
                        @error('pindah_ke')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    <label for="alasan_keluar" class="col-md-4 col-form-label text-md-right"
                        title="Alasan khusus yang melatarbelakangi peserta didik keluar dari sekolah.">Alasan</label>
                    <div class="col-md-6">
                ...
                <div class="form-group row">
                    <label for="tanggal_keluar" class="col-md-4 col-form-label text-md-right"
                        title="Tanggal saat peserta didik diketahui/tercatat keluar dari sekolah.">Tanggal Keluar</label>
                    <div class="col-md-6">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input type="text" class="form-control @error('nama_ayah') is-invalid @enderror" id="nama_ayah"
                            placeholder="Masukan Nama Ayah Kandung" name="nama_ayah"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input type="text" class="form-control @error('nama_ibu') is-invalid @enderror" id="nama_ibu"
                            placeholder="Masukan Nama Ibu Kandung" name="nama_ibu"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input type="number" min="1950" max="2099" step="1" placeholder="Mssukan Tahun Lahir"
                            ...
                            name="tahun_lahir_ibu" value="{{ old('tahun_lahir_ibu', $peserta_didik->tahun_lahir_ibu) }}">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-6">
                        <input type="text" class="form-control @error('nama_wali') is-invalid @enderror" id="nama_wali"
                            placeholder="Masukan Nama Wali" name="nama_wali"
