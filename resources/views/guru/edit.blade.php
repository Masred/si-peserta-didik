                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="number" min="1" name="rt" id="rt"
                                       ...
                                       placeholder="Masukan RT" value="{{ old('rt', $guru->rt) }}">
                                @error('rt')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="number" min="1" name="rw" id="rw"
                                       ...
                                       placeholder="Masukan RW" value="{{ old('rw', $guru->rw) }}">
                                @error('rw')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="kelurahan" id="kelurahan"
                                       ...
                                       placeholder="Masukan Kelurahan/Desa" value="{{ old('kelurahan', $guru->kelurahan) }}">
                                @error('kelurahan')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="text" name="kecamatan" id="kecamatan"
                                       ...
                                       placeholder="Masukan Kecamatan" value="{{ old('kecamatan', $guru->kecamatan) }}">
                                @error('kecamatan')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="number" min="1" name="kode_pos" id="kode_pos"
                                       ...
                                       placeholder="Masukan Kode Pos" value="{{ old('kode_pos', $guru->kode_pos) }}">
                                @error('kode_pos')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
